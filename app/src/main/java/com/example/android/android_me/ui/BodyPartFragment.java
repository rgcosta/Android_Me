...
public class BodyPartFragment extends Fragment {
    ...
    private static final String IMAGES_ID_LIST_KEY = "images_id_list_key";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            this.mImageIds = savedInstanceState.getIntegerArrayList(IMAGES_ID_LIST_KEY);
            this.mListIndex = savedInstanceState.getInt(LIST_INDEX_KEY);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putIntegerArrayList(IMAGES_ID_LIST_KEY, (ArrayList<Integer>) mImageIds);
